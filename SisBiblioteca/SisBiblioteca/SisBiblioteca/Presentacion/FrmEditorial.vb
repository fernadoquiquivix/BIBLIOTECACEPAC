...
Public Class FrmEditorial
    ...
    Private Sub txtnombre_Validating(sender As Object, e As CancelEventArgs) Handles txtnombre.Validating
        ...
        Else
            Me.erroricono.SetError(sender, "Ingrese el nombre de la Editorial")
        End If
    End Sub
        ...
        If Me.ValidateChildren = True And txtnombre.Text <> "" Then
            Try
                ...
                If func.insertar(dts) Then
                    MessageBox.Show("Editorial registrada correctamente", "Guardando Registros", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    mostrar()
                    limpiar()
                Else
                    MessageBox.Show("Editorial no registrada intente de nuevo", "Guardando Registros", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    mostrar()
                    limpiar()
                End If
    ...
    Private Sub datalistado_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles datalistado.CellClick
        txtideditorial.Text = datalistado.SelectedCells.Item(1).Value
    ...
    Private Sub btnEditar_Click(sender As Object, e As EventArgs) Handles btnEditar.Click
        ...
        result = MessageBox.Show("Realmente desea editar los datos de la Editorial?", "Modificar Registros", MessageBoxButtons.OKCancel, MessageBoxIcon.Question)
            ...
            If Me.ValidateChildren = True And txtnombre.Text <> "" Then
                Try
                    ...
                    If func.editar(dts) Then
                        MessageBox.Show("Editorial modificada correctamente", "Modificando Registros", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        mostrar()
                        limpiar()
                    Else
                        MessageBox.Show("Editorial no fue modificada intente de nuevo", "Modificando Registros", MessageBoxButtons.OK, MessageBoxIcon.Error)
                        mostrar()
                        limpiar()
                    End If
    ...
    Private Sub btnEliminar_Click(sender As Object, e As EventArgs) Handles btnEliminar.Click
        ...
        result = MessageBox.Show("Realmente desea Eliminar las Categorias seleccionadas?", "Eliminar Categorias", MessageBoxButtons.OKCancel, MessageBoxIcon.Question)
        If result = DialogResult.OK Then
            Try
                For Each row As DataGridViewRow In datalistado.Rows
                    ...
                    If marcado Then
                        ...
                        Else
                            MessageBox.Show("Categoria no Eliminada", "Eliminando Registros", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        End If
                    End If
    ...
    Private Sub datalistado_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles datalistado.CellDoubleClick
        If txtflag.Text = "1" Then
            frmLibros.txtidcategoria.Text = datalistado.SelectedCells.Item(1).Value
            frmLibros.txtnombre_categoria.Text = datalistado.SelectedCells.Item(2).Value
            Me.Close()
