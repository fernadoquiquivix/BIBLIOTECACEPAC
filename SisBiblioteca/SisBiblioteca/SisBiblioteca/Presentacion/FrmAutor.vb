...
Public Class FrmAutor
    ...
    Private Sub txtnombre_Validating(sender As Object, e As CancelEventArgs) Handles txtnombre.Validating
        ...
        Else
            Me.erroricono.SetError(sender, "Ingrese el nombre del autor")
        End If
    End Sub
    ...
    Private Sub txtdireccion_Validating(sender As Object, e As CancelEventArgs) Handles txtdireccion.Validating
        If DirectCast(sender, TextBox).Text.Length > 0 Then
            Me.erroricono.SetError(sender, "")
        Else
            Me.erroricono.SetError(sender, "Ingrese la direccion del autor")
        End If
    End Sub
    ...
    Private Sub txttelefono_Validating(sender As Object, e As CancelEventArgs) Handles txttelefono.Validating
        If DirectCast(sender, TextBox).Text.Length > 0 Then
            Me.erroricono.SetError(sender, "")
        Else
            Me.erroricono.SetError(sender, "Ingrese el telefono del autor")
        End If
    End Sub
        ...
        If Me.ValidateChildren = True And txtnombre.Text <> "" And txtdireccion.Text <> "" And txtemail.Text <> "" And txttelefono.Text <> "" Then
            Try
                ...
                If func.insertar(dts) Then
                    MessageBox.Show("Autor registrado correctamente", "Guardando Registros", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    mostrar()
                    limpiar()
                Else
                    MessageBox.Show("Autor no registrado intente de nuevo", "Guardando Registros", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    mostrar()
                    limpiar()
                End If
    ...
    Private Sub datalistado_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles datalistado.CellContentClick
        ...
        End If
        'datalistado.Columns("EMAIL").HeaderText = "CORREO"

    End Sub

    Private Sub datalistado_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles datalistado.CellClick
        txtidautor.Text = datalistado.SelectedCells.Item(1).Value
    ...
    Private Sub btnEditar_Click(sender As Object, e As EventArgs) Handles btnEditar.Click
        ...
        result = MessageBox.Show("Realmente desea editar los datos de los Autores?", "Modificar Registros", MessageBoxButtons.OKCancel, MessageBoxIcon.Question)
            ...
            If Me.ValidateChildren = True And txtnombre.Text <> "" And txtdireccion.Text <> "" And txtemail.Text <> "" And txttelefono.Text <> "" Then
                Try
                    ...
                    If func.editar(dts) Then
                        MessageBox.Show("Autor modificado correctamente", "Modificando Registros", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        mostrar()
                        limpiar()
                    Else
                        MessageBox.Show("Autor no fue modificado intente de nuevo", "Modificando Registros", MessageBoxButtons.OK, MessageBoxIcon.Error)
                        mostrar()
                        limpiar()
                    End If
    ...
    Private Sub btnEliminar_Click(sender As Object, e As EventArgs) Handles btnEliminar.Click
        ...
        result = MessageBox.Show("Realmente desea Eliminar a los Autores seleccionados?", "Eliminar Autores", MessageBoxButtons.OKCancel, MessageBoxIcon.Question)
        If result = DialogResult.OK Then
            Try
                For Each row As DataGridViewRow In datalistado.Rows
                    ...
                    If marcado Then
                        Dim onekey As Integer = Convert.ToInt32(row.Cells("IDAUTOR").Value)
                        Dim vdb As New Vautor
                        Dim func As New Fautor
                        vdb.GIDAUTOR = onekey
