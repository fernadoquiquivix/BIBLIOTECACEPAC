...
Public Class frmBuscarAutor
    ...
    Private Sub ocultar_columnas()
        'datalistado.Columns(1).Visible = False     /lo oculte porque me sirve el numero
    ...
    Private Sub datalistado_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles datalistado.CellDoubleClick
        Try
            ...
            dts.GIDCODIGOAUTOR = Me.datalistado.Item(0, e.RowIndex).Value
            'FrmRegistroLibro_.TxtAutorLibro.Text = Me.datalistado.Item(1, e.RowIndex).Value
            FrmRegistroLibro_.TxtAutorLibro.Text = datalistado.SelectedCells.Item(1).Value
            dts.GIDCODIGOAUTOR = datalistado.SelectedCells.Item(0).Value
