...
Public Class flibro
    ...
    Dim DatoEstado As New DataTable
    ...
    Public Function insertar(ByVal dts As vlibro) As Boolean
        ...
        End Try
    End Function
    Public Function insertar_new(ByVal dts As vlibro) As Boolean
        Try
            'envio parametros a la base de datos
            conectado()
            cmd = New SqlCommand("insertar_libro_new")
            cmd.CommandType = CommandType.StoredProcedure
            cmd.Connection = cnn
            ...
            cmd.Parameters.AddWithValue("@IDESTADO", dts.GIDESTADO)
            cmd.Parameters.AddWithValue("@IMAGEN", dts.GIMAGEN)
            cmd.Parameters.AddWithValue("@OBSERVACION", dts.GDESCRIPCION)
    ...
    End Function
    Public Sub LlenarEstadoLibro(ByVal Pais As ComboBox)
        ClaseConexion.conectar()
        Try
            Dim selectdoc As String = "Select IdEstado, NOMBRE NombreEstado from estado "
            DatoEstado.Clear()
            Dim adaptador As New SqlDataAdapter(selectdoc, ClaseConexion.con)
            adaptador.Fill(DatoEstado)
            Pais.DataSource = (DatoEstado)
            Pais.DisplayMember = "NombreEstado"
            Pais.ValueMember = "IdEstado"
